...
from experiments import (
    ...
    apply_multiple_binary_decision_tree_classifiers_per_activity,
...
apply_multiple_binary_decision_tree_classifiers_per_activity(X_train, X_valid, y_train, y_valid)
