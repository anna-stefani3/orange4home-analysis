...
from experiments import (
    ...
    apply_gmmhmm_to_classify_activity_directly,
    ...
    apply_gmmhmm_to_classify_location_then_activity,
...
apply_gmmhmm_to_classify_activity_directly(X_train, X_valid, y_train, y_valid)
...
apply_gmmhmm_to_classify_location_then_activity(X_train, X_valid, y_train, y_valid)
